  ...
  return (
    <form className='register-form'>
      ...
      <div className="register-form-input-group">
        <h6>Email</h6>
        <input className="register-form-input" placeholder='email' name="emial" required ref={emailRef} />
      </div>
      <div className="register-form-input-group">
        <h6>Password</h6>
      ...
      <button className="register-from-
      submit" onClick={handleRegisterUser}>Register</button>
